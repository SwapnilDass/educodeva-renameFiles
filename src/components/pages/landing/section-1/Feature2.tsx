export default function Feature2() {
  return (
    <div className="bg-[#1E1B38] border border-white/20 rounded-[10px] px-5 pt-2 pb-4 md:px-6 md:pt-3 md:pb-5 flex flex-col justify-start gap-3 md:gap-4 w-full overflow-hidden
      "
    >
      {/* Dashboard*/}
